      ...
      {isOpen && (
        <div className='absolute top-16 right-0 z-50 w-48 bg-gradient-to-br from-primary-light to-primary text-white shadow-lg rounded-lg'>
          <ul className='p-4'>
            ...
            <li>
              <button className='w-full text-left py-1 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 hover:bg-primary-dark text-lg font-semibold'>
                Logout
              </button>
            </li>
          </ul>
